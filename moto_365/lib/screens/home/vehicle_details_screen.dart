...
import 'package:moto_365/obd/MainPage.dart';
...
import 'package:moto_365/screens/map/analetics.dart';
import 'package:moto_365/screens/map/obd.dart';
    ...
    return Grad(
      child: Background(
        child: Scaffold(
            ...
            body: widget.vehicle == {}
                ? Center(
                    child: Text("No Vehicle Has Beenn Added"),
                  )
                : data.isDetailed
                    ? Center(
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${widget.vehicle["insurance_upto"]??"not available"}",
                                                      style: TextStyle(
                                                          color: Colors.white60,
                                                          fontSize: 14),
                                                    ),
                                    ...
                                    return GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: [
                                            Image.asset(
                                              data.typeDetails[index]["img"],
                                              height: 50,
                                            ),
                                            Text(data.typeDetails[index]
                                                ["name"]),
                                          ],
                                        ),
                                      ),
