                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Text(
                              data.vehicles.isEmpty || data.vehicles == null
                                  ? ""
          ...
          onPressed: () {
            if (data.vehicles.isEmpty) {
              Scaffold.of(context).showSnackBar(
                  SnackBar(content: Text("No Vehicles Added Yet")));
            }else{
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => VehicleDetails(
                      cusVehicle:  data.vehicles[0],
                                ...
                                child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: <Widget>[
                                              Image(image: AssetImage("assets/images/insuread.png"),height: 200,width: 200,),
                                              Column(
