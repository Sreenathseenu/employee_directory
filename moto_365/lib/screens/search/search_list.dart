...
class _SearchListState extends State<SearchList> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:list==null||list==[]?Center(child:Text('no item')) :GridView.builder(
          ...
          itemCount:widget.cat != 'Accessories'
                    ?services.serviceGroup.length : products.items.length,
                          ...
                          Expanded(
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image(
                                    image: services.serviceGroup[index]['image']==""
                                        ? AssetImage('assets/images/slice.png')
                                        : NetworkImage(
                                            "https://automoto.techbyheart.in${services.serviceGroup[index]['image']}"),
                                    fit: BoxFit.cover,
                                    height: 125,
                                    width: 120),
                              ),
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(
                                    8), //BorderRadius.only(topLeft: Radius.circular(8),topRight: Radius.circular(8)),
                                child: Image(
                                  image: products.items[index]
                                              ['image']==""
                                      ? AssetImage('assets/images/slice.png')
                                      : NetworkImage(
                                          "https://automoto.techbyheart.in${products.items[index]
                                              ['image']}"),
                                  fit: BoxFit.cover,
                                  height: 125,
                                  width: 120,
