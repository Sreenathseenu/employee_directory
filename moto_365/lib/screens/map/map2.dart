...
import 'package:moto_365/screens/map/hud.dart';
import 'package:moto_365/screens/map/map.dart';
import 'package:moto_365/screens/map/mapSearch.dart';
import 'package:provider/provider.dart';
...
class Map2 extends StatefulWidget {
  ...
  final latoriginal;
  final longoriginal;
  Map2({Key key, this.lat2, this.long2, this.latoriginal, this.longoriginal}) : super(key: key);
      ...
      body: lat == null
          ...
          FlutterMap(
              options: new MapOptions(
                ...
                center: ll.LatLng(widget.lat2, widget.long2),
                zoom: 14.0,
              ),
              layers: [
                new TileLayerOptions(
                  urlTemplate:
                      "https://api.mapbox.com/styles/v1/sreenath2099/ckbug8wae0ghx1jo7rv88pj1c/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1Ijoic3JlZW5hdGgyMDk5IiwiYSI6ImNrN3I0bG4xdzBhbG4zZW12OGpjbGlodzQifQ.DLnMLN92Ipxgx8STc8LdCg",
                ...
                new MarkerLayerOptions(
                  markers: [
                    new Marker(
                      ...
                      height: 80.0,
                      point: lat == null
                          ? new ll.LatLng(9.9707358, 76.2998098)
                          : new ll.LatLng(widget.lat2, widget.long2),
                  ...
                  onTap: () {
                   Navigator.of(context)
                                            .push(MaterialPageRoute(
                                                builder: (context) => Hud(
                                                      slat: widget.latoriginal,
                                                      slong: widget.longoriginal,
                                                      flong: widget.long2,
                                                      flat: widget.lat2,
                                                    )));
                  },
