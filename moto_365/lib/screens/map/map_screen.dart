...
class _MapState extends State<Map> {
  ...
  child: Icon(Icons.rotate_left, size: 100,),
    ...
    return Scaffold(
      ...
      //           width: 80.0,
      //           height: 80.0,
      //           point:lat==null?new ll.LatLng(9.9707358, 76.2998098): new ll.LatLng(lat, long),
      //           builder: (ctx) =>
      //           new Container(
      ...
      floatingActionButton: FloatingActionButton(child: Icon(Icons.search),onPressed: (){
        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>MapSearch(lat: lat,long: long,)));
      },),
        ...
        builder: (context) => Container(
            ...
            child: Column(
              children: [
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>AutomotoServices()));
                  },
                  child: Container(
                    width: 100,
                    height: 10,
